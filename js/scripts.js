...
let checkMayor= document.getElementById('checkmayor');
let checkMenor= document.getElementById('checkmenor');
...
checkMayor.addEventListener('change', function (e){
    if (e.target.checked){
    var r = confirm("ordenar por mayor precio?")
    listaAnuncio = obtenerAnuncio();
    if(r==true){
        listaAnuncio.sort(function(a,b){
...
checkMenor.addEventListener('change', function (e){
    if (e.target.checked){
    var r = confirm("ordenar por menor precio?")
    listaAnuncio = obtenerAnuncio();
    if(r==true){
        listaAnuncio.sort(function(a,b){
